...
[ "___SAFE_CALC_INIT__", "___CALC_INIT__", "___GET_SIGN_NEGATIVE__", "___GET_SIGN_POSITIVE__", "___SAFE_SET_SIGN_NEGATIVE__", "___SAFE_SET_SIGN_POSITIVE__", "___GET_CUSTOM_INTEGER_DEF_NUMBER_CHARSET__", "___SAFE_SET_CUSTOM_INTEGER_DEF_NUMBER_CHARSET__", "___SET_CUSTOM_INTEGER_DEF_NUMBER_CHARSET__", "___ADD_INTEGER__", "___SUB_INTEGER__", "___MUL_INTEGER__", "___SUB_INTEGER_OR_NEGATIVE__", "___IS_SIGN_NEGATIVE__", "___ADD_INTEGER_AND_POSITIVE__", "___SUB_INTEGER_AND_POSITIVE__", "___ADD_INTEGER_OR_NEGATIVE__", "___ADD_REP_INTEGER__", "___SET_SIGN_POSITIVE__", "___IS_SIGN_POSITIVE__", "___IS_SIGN_NULL__", "_fflush", "__ZN6__asan9FakeStack17AddrIsInFakeStackEm", "__ZN6__asan9FakeStack8AllocateEmmm", "onRuntimeInitialized" ].forEach(prop => {
...
var ASM_CONSTS = {
 9945504: () => {
  return withBuiltinMalloc(function() {
   return stringToNewUTF8(Module["ASAN_OPTIONS"] || 0);
  });
 },
 9945604: () => {
  return withBuiltinMalloc(function() {
...
var ___GET_SIGN_POSITIVE__ = Module["___GET_SIGN_POSITIVE__"] = createExportWrapper("__GET_SIGN_POSITIVE__");
...
var ___CALC_INIT__ = Module["___CALC_INIT__"] = createExportWrapper("__CALC_INIT__");
...
var __asan_c_load_1 = function() {
 return (__asan_c_load_1 = Module["asm"]["_asan_c_load_1"]).apply(null, arguments);
};

var __asan_c_load_1u = function() {
 return (__asan_c_load_1u = Module["asm"]["_asan_c_load_1u"]).apply(null, arguments);
};

var __asan_c_load_2 = function() {
 return (__asan_c_load_2 = Module["asm"]["_asan_c_load_2"]).apply(null, arguments);
};

var __asan_c_load_2u = function() {
 return (__asan_c_load_2u = Module["asm"]["_asan_c_load_2u"]).apply(null, arguments);
};

var __asan_c_load_4 = function() {
 return (__asan_c_load_4 = Module["asm"]["_asan_c_load_4"]).apply(null, arguments);
};

var __asan_c_load_4u = function() {
 return (__asan_c_load_4u = Module["asm"]["_asan_c_load_4u"]).apply(null, arguments);
};

var __asan_c_load_f = function() {
 return (__asan_c_load_f = Module["asm"]["_asan_c_load_f"]).apply(null, arguments);
};

var __asan_c_load_d = function() {
 return (__asan_c_load_d = Module["asm"]["_asan_c_load_d"]).apply(null, arguments);
};

var __asan_c_store_1 = function() {
 return (__asan_c_store_1 = Module["asm"]["_asan_c_store_1"]).apply(null, arguments);
};

var __asan_c_store_1u = function() {
 return (__asan_c_store_1u = Module["asm"]["_asan_c_store_1u"]).apply(null, arguments);
};

var __asan_c_store_2 = function() {
 return (__asan_c_store_2 = Module["asm"]["_asan_c_store_2"]).apply(null, arguments);
};

var __asan_c_store_2u = function() {
 return (__asan_c_store_2u = Module["asm"]["_asan_c_store_2u"]).apply(null, arguments);
};

var __asan_c_store_4 = function() {
 return (__asan_c_store_4 = Module["asm"]["_asan_c_store_4"]).apply(null, arguments);
};

var __asan_c_store_4u = function() {
 return (__asan_c_store_4u = Module["asm"]["_asan_c_store_4u"]).apply(null, arguments);
};

var __asan_c_store_f = function() {
 return (__asan_c_store_f = Module["asm"]["_asan_c_store_f"]).apply(null, arguments);
};

var __asan_c_store_d = function() {
 return (__asan_c_store_d = Module["asm"]["_asan_c_store_d"]).apply(null, arguments);
};
